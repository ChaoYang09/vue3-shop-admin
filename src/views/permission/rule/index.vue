<template>
    ...
    >
      ...
      <vxe-column title="操作" min-width="100">
        <template #default="scope">
          <el-button type="primary" text @click="handleCreate(scope.row.id)"> 添加规则 </el-button>
          <el-button type="primary" text @click="handleUpdate(scope.row.id)"> 编辑 </el-button>
  ...
  <RuleForm v-model="formVisible" v-model:rule-id="ruleId" @success="handleFormSuccess" />
</template>
